...
<div class="flex min-h-full flex-col justify-center px-6 py-9 md:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <h1 class="mt-3 text-center text-4xl leading-8 tracking-tight text-gray-200 font-extrabold">Admin Login</h1>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="{{ route('admin.login') }}" method="POST">
        @csrf
        <div>
          <label for="name" class="block text-base font-medium leading-6 text-white">Name</label>
          <div class="mt-2">
        ...
        <div>
          <label for="password" class="block text-base font-medium leading-6 text-white">Password</label>
          <div class="mt-2">
        ...
        <div>
          <input id="submit" type="submit" class="flex w-full justify-center rounded-md bg-zinc-100 px-3 py-3 font-semibold leading-6 text-gray-900 shadow-sm hover:bg-slate-500 hover:text-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 text-lg cursor-pointer" value="Admin Login" />
          <div class="loader-animation relative flex justify-center items-center">
            <svg aria-hidden="true" id="loader" role="status" class="absolute -top-9 md:right-12 hidden right-32 w-7 h-7 me-3 text-black animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
